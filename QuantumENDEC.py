			...
			if ".py" in plug:
				...
				try:
					...
					match mode:
						...
						case _:
							print("The plugin caller tried to use a method that is not implemented.")
	...
	if ZCZC is not None:
		try:
			...
			if evnt in colEvtlist:
				match colEvtlist[evnt]
					case 0:
						embed_color = ConfigData["CGENcolor_warning"]
					case 1:
						embed_color = ConfigData["CGENcolor_watch"]
	...
	try:
		...
		<alert>
			...
			<info>
				...
				<description>From {oof.callsign}</description>
				{embedded_audio}
